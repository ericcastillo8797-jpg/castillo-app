...
(function (w) {
  ...
  var UI = {
    ...
    // acceso
    'Acceder': 'Sign in', 'Acceder con Face ID': 'Sign in with Face ID', 'Aquí aparecerá tu próxima foto': 'Your next photo will appear here', 'Aquí aparecerán tus últimas fotos, para que veas tu cambio': 'Your latest photos will appear here, so you can see your change', 'Accediendo…': 'Signing in…', 'Identificado': 'Identified', 'Mire al iPhone': 'Look at your iPhone', 'Saltar': 'Skip',
  ...
  function tdate(s, lang) {
    ...
    // En español el mes abreviado lleva punto ("18 sep."); en inglés no ("18 Sep").
    out = out.replace(/\b(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\./g, '$1');
